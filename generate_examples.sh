...
int main(int argc, char *argv[])
{
    ...
    FontUtils::load_dingtalk_jinbuti_font();
    AppUtils::load_style("://resources/examples.css");
...
target_link_libraries(example-$name wpui Qt\${QT_VERSION_MAJOR}::Widgets Qt\${QT_VERSION_MAJOR}::Multimedia)
